...
PulseFlow 0.6.0 adds a local pairing flow that behaves like a deliberate device connection without pretending that opening the dashboard grants control.
