...
PulseFlow 0.6.0 controls one selected Windows process at a time through process priority and EcoQoS. It observes the whole machine. It does not alter clocks, voltage, fan curves, firmware or GPU power limits.
